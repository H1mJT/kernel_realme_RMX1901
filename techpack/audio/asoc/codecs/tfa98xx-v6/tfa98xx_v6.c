...
#ifndef VENDOR_EDIT
//Nan.Zhong@PSW.MM.AudioDriver.SmartPA, 2019/06/11, Modify for multi-project baseline
/*
...
static int tfa98xx_probe(struct snd_soc_codec *codec)
{
	...
	int ret = 0;
	#ifndef VENDOR_EDIT
	/*Jianfeng.Qiu@PSW.MM.AudioDriver.SmartPA, 2019/03/28, Add for i2c read fail at i2c probe*/
	int i = 0;
	unsigned int reg;
	#endif /* VENDOR_EDIT */
